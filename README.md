...
## GitHub（GitHub Desktop + Pages）

**方針: パターンA（Public リポジトリ + GitHub Pages）**

1. `GITHUB_DESKTOP手順.md` — リポジトリ運用
2. `GITHUB_PAGES手順.md` — **Public 化・Pages 有効化**（未完了ならこちら）
3. 公開URL: `https://murakumo2000.github.io/dmz-tactical-lab/`
4. 日常: Obsidian で編集 → `docs/` 同期 → GitHub Desktop で Push
